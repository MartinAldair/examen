 ...
 * hacerlo en este caso, se utilizo el metodo Unchecked Exception que son
 * aquellas que pueden ocurrir en tiempo de ejecución, por lo que para crear
 * este tipo de excepción se tiene que extender de runtime.
 *
